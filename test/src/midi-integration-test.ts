...
import { TrellisMidiTester } from './trellis-midi-tester';
...
async function runContinuousMonitoring(tester: TrellisMidiTester, options: CliOptions): Promise<void> {
...
async function main(): Promise<void> {
  ...
  try {
    const tester = new TrellisMidiTester();
